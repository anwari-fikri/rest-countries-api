...
const CountryPage = () => {
  ...
  return (
    <div className="min-h-screen very-light-gray-light dark:bg-very-dark-blue-dark dark:text-white">
      <div className="flex flex-col px-4 py-10 md:px-14">
        <div className="w-fit shadow-lg border border-dark-gray-light/20  bg-white dark:bg-dark-blue-dark dark:text-white">
          <button
            className="flex items-center gap-5 text-sm md:text-base px-7 py-2"
            onClick={handleClick}
          >
            <BsArrowLeft />
            Back
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-40 space-y-7 py-10 font-semibold text-sm md:text-base">
          <div>
            {country && (
          ...
          <div className="flex flex-col gap-5 md:gap-14">
            ...
            <div className="flex flex-col gap-5 md:gap-24 md:flex-row">
              <div>
                {country && (
            ...
            <div className="space-y-2">
              ...
              <div class="grid-cols-3 grid gap-3 md:grid-cols-4">
